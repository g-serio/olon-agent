...
const TYPOGRAPHY_DIRECTION_PRESETS: TypographyDirectionPreset[] = [
  {
    ...
    summary: "Titoli autorevoli, testo calmo, tono magazine.",
    rationale: "Ideale per tenant narrativi, editoriali o premium con ritmo elegante.",
  ...
  },
  {
    id: "brand-sans",
    label: "Neutral Sans",
    summary: "Pulito, contemporaneo, adatto a brand e prodotti generalisti.",
    rationale: "Riduce la complessita e mantiene una base molto versatile.",
    primary: "Manrope",
  ...
  },
  {
    id: "tech-stack",
    label: "Tech Stack",
    summary: "UI precisa, testo nitido, accento operativo.",
    rationale: "Buono per prodotti software, dashboard e narrazioni piu sistemiche.",
  ...
  },
  {
    ...
    summary: "Contrasto alto tra body sobrio e titoli iconici.",
    rationale: "Per esperienze piu moda, hospitality o luxury brand.",
    primary: "Manrope",
  ...
  },
  {
    ...
    summary: "Più carattere, tono creativo, energia contemporanea.",
    rationale: "Funziona quando il brand vuole una voce meno neutra e piu distintiva.",
    primary: "Sora",
